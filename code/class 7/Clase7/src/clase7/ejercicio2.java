 ...
 *
 *
 * Cargar un String por teclado e implementar los siguientes metodos: a)Imprimir
 * la primera mitad de los caracteres de la cadena. b)Imprimir el ultimo
 * caracter. c) imprimirlo en forma inversa. d) Imprimir cada caracter del
 * String separado con un guion. e)Imprimir la cantidad de vocales.
